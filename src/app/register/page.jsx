      ...
      <div className="flex justify-center items-center w-full py-10 px-2">
        <div className="w-full max-w-lg bg-gradient-to-b from-[#7b7bbd] to-[#2d184a] rounded-[2.5rem] shadow-lg p-10 flex flex-col items-center">
          ...
          <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4">
            ...
            <button
              type="submit"
              className="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-3 px-8 rounded-xl shadow transition duration-150 mt-2"
            >
              Register
            </button>
          </form>
          <div className="w-full mt-8 text-center text-gray-200">
            Already have an account ?{" "}
            <Link
              className="text-indigo-200 hover:underline font-semibold"
              href="/login"
            >
              Login
            </Link>
