...
export default function AdminDashboardClient({
  ...
  const roomsForDisplay = useMemo(
    ...
    () =>
      ...
      (rooms || []).map((room) => ({
        ...
        liveStatus: room?.liveStatus ?? room?.status,
  ...
  }, [roomsForDisplay, roomSearch, roomStatus]);
  ...
  async function handleRoomSlotEdit(room) {
    ...
    try {
      ...
      let booking = bookings.find((b) => b.bookingId === room.activeBookingId);
      ...
      if (!booking) {
        ...
        booking = await fetchBookingById(room.activeBookingId);
      ...
      const bookingDateIso = booking?.date
      ...
      setBookingDraft({
        ...
        timeSlot: booking.timeSlot || room.activeBookingTimeSlot || "",
